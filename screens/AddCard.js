...
const AddCard = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.backgroundStyle}>
            ...
            <SafeAreaView>
                <HeaderView navType="back" screenName="Add Card" borderVisible={false} action={() => { navigation.goBack() }} >
            ...
            <View style={styles.wrapper}>
                <SafeAreaView style={{ backgroundColor: palette.white, borderRadius: 10, width: '100%', flex: 1 }}>
                    ...
                    <View style={[styles.defaultContainer, styles.defaultPadding, { backgroundColor: palette.inputbg, width: '100%', zIndex: 5, alignItems: 'center', flex: 1 }]}>
