...
function Chat({ navigation, route }) {
    ...
    return (
        <KeyboardAvoidingView behavior='padding' keyboardVerticalOffset={Platform.select({ ios: 80, android: -insets.bottom })} style={[styles.w100, styles.flexOne]}>
            <ScreenWrapper screenName={t('chat')} navAction={() => navigation.goBack()} navType="back">
                <ScrollView keyboardShouldPersistTaps={'handled'} style={styles.flexOne} contentContainerStyle={[styles.alignCenter, styles.w100]}
                    ref={ref}
                ...
                <View style={[styles.w100, styles.flexRow, styles.pt8, { paddingBottom:  insets.bottom + 10, paddingHorizontal: 12 * rem, alignSelf: 'flex-end'}]}>
